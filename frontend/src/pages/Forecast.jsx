      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold tracking-tight font-display text-slate-900">{t('forecast_title')}</h1>
              <p className="text-slate-500 text-xs mt-0.5 font-medium">{t('forecast_desc')}</p>
            </div>
          </div>
          <button onClick={fetchForecast} className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-xs font-bold text-teal-700 shadow-sm cursor-pointer">
