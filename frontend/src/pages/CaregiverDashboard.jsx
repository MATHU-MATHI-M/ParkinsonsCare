    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 px-4 md:px-8 py-8 font-sans">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-slate-500 text-xs mt-0.5 font-medium">Track daily task checklists and prescription safety compliance for assigned patients</p>
        </div>
        ...
        {patients.length === 0 ? (
          <div className="bg-white border border-slate-200 p-12 rounded-2xl text-center py-16 shadow-sm">
            ...
            <h3 className="text-lg font-bold font-display text-slate-900 mb-2">No Patients Assigned</h3>
