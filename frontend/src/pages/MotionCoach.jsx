    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 px-4 py-8 font-sans">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight font-display text-slate-900">AI Exercise Coach</h1>
            <p className="text-slate-500 text-xs mt-0.5 font-medium">Guided therapeutic exercises with real-time voice coaching feedback</p>
          </div>
        </div>
